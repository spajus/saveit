class HomeController < ApplicationController
  ...
  def index
    if current_user
      gon.visited_bookmarks = current_bookmarks.visited(true).as_api_response(:default)
      gon.unvisited_bookmarks = current_bookmarks.visited(false).as_api_response(:default)
    end
